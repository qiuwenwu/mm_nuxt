		...
		<main>
			<mm_warp>
                ...
                <button class="btn_primary fr" @click="show1 = true">显示代码</button>
						...
						<mm_col width="100">
							<mm_view class="card">
									<list_number :col="col" :list="list" :class="'list-x ' + list_layout[select]">
									</list_number>
							</mm_view>
						</mm_col>
					</mm_row>
...
<list_number :col="col" :list="list" :class="'list-x ' + list_layout[select]"></list_number>`,
js1: `export default {
	data(){
	list_layout: [
	  "item-tb",
