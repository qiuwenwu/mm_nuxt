      ...
      <mm_warp>
        <mm_container>
          <mm_row>
            ...
            <mm_col width="100">
              <mm_view>
                <list_goods :col="col" :list="list" :class="'list-x ' + list_layout[select]">
                </list_goods>
              </mm_view>
            </mm_col>
          </mm_row>
...
<list_goods :col="col" :list="list" :class="'list-x ' + list_layout[select]"></list_goods>`,
        js1: `export default {
	data(){
	list_layout: [
	  "item-ltb img-larger",
